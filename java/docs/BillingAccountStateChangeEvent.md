...
**payload** | [**BillingAccountStateChangeEventPayload**](BillingAccountStateChangeEventPayload.md) | The event payload linked to the involved resource object |  [optional]
